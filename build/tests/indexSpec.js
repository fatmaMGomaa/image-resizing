...
describe('Test images resizing endpoints responses', function () {
    it('resizing an image response test', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    it('uncorrect width or height params-resizing endpoint server error', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/images/api/resizing?file_name=dogs.jpeg')];
                case 1:
                    response = _a.sent();
...
describe('Test images resizing middlewares', function () {
    it('test existing middleware - not existing image ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/images/api/resizing?width=300&height=300&file_name=cows.jpeg')];
                case 1:
                    response = _a.sent();
    ...
    it('test caching middleware - cached image ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/images/api/resizing?width=300&height=300&file_name=dogs.jpeg')];
